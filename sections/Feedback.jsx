  ...
  <section className={`${styles.paddings} relative z-10`}>
    <motion.div 
      ...
      <motion.div variants={fadeIn('right', 'tween', 0.2, 1)}
        className='flex-[0.5] lg:max-w-[370px] flex justify-end flex-col grandient-05 sm:p-8 p-4 rounded-[32px] border-[1px] border-[#6a6a6a] relative'>
...
<div className='feedback-gradient' />
      ...
      <motion.div variants={fadeIn('left', 'tween', 0.2, 1)}
        ...
        <img src='/planet-09.png' className='w-full lg:h-[610px] h-auto min-h-[210px] object-cover rounded-[40px]' />
